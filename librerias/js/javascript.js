...
function ezeiza(event){
    ...
    if(valueAepChoice = 1){
        ...
        console.log(inn)
        inn.innerText = "El costo de su viaje es de " + calculoViaje(precioKm, kms) + ". lo pasaremos a buscar el " + dt.toLocaleString(DateTime.DATE_FULL) + " por el aeropuerto elegido."
